...
- **2026-06-27a** — Added `cross-repo-coordination.md` (COG-42 / CF-10) and `roadmap-and-version-broadcast.md` (COG-47 / CF-9) to the tracked sources — both migrated from chronoforge into `cogworks/runbooks/`.
...
| Roadmap & version broadcast | Convention | `cogworks/runbooks/roadmap-and-version-broadcast.md` § Standards changelog | Cog `CLAUDE.md` |
