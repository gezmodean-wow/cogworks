# Cogworks — Wago listing copy

> Paste this into the Wago project description after creating the `cogworks` project under the `gezmodean-wow` author. Wago renders standard markdown — this file should drop in cleanly with no conversion needed.
...
## Wago project metadata

- **Project name:** Cogworks
- **Project slug:** `cogworks`
- **Category:** Libraries
- **Game version:** The War Within (Retail)
- **Source URL:** https://github.com/gezmodean-wow/cogworks
- **License:** MIT

## Images needed

- 256×256 project logo
- Optional: a screenshot of `/cogworks status` in chat with a couple of cogs registered
